...
# Student: Deiven Joseph Pimentel
...
def main(page: ft.Page):
    ...
    student_info = ft.Column([
        ...
        ft.Text("Name: Deiven Joseph Pimentel", size=14),
        ft.Text("Student ID: 231002335", size=14),
    ...
    def show_info(e):
        ...
        page.dialog = dialog
        dialog.open = True
        page.open(dialog) # added this because without it the dialog does not open
        page.update()
